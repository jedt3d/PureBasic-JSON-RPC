...
Procedure SQLiteAdmin_Bootstrap(*dispatcher.JSONRPC_Dispatcher, dbName.s)
  ...
  Assert(FindString(response, SQLiteAdmin_TestRoot(), 1) = 0, "sqlite/bootstrap should not expose an absolute test root.")
  Assert(FindString(response, ".local/sqlite-admin-tests/", 1) > 0, "sqlite/bootstrap should report a project-root-relative path.")
EndProcedure
...
ProcedureUnit SQLiteAdminCsvExportWritesCanonicalCsv()
  ...
  Assert(FindString(response, SQLiteAdmin_TestRoot(), 1) = 0, "CSV export response should not expose an absolute test root.")
  Assert(FindString(response, ".local/sqlite-admin-tests/exports/", 1) > 0, "CSV export response should report a project-root-relative path.")
...
ProcedureUnit SQLiteAdminOdsExportWritesOpenDocumentPackage()
  ...
  Assert(FindString(response, SQLiteAdmin_TestRoot(), 1) = 0, "ODS export response should not expose an absolute test root.")
  Assert(FindString(response, ".local/sqlite-admin-tests/exports/", 1) > 0, "ODS export response should report a project-root-relative path.")
...
ProcedureUnit SQLiteAdminXlsxExportWritesOpenXmlPackage()
  ...
  Assert(FindString(response, SQLiteAdmin_TestRoot(), 1) = 0, "XLSX export response should not expose an absolute test root.")
  Assert(FindString(response, ".local/sqlite-admin-tests/exports/", 1) > 0, "XLSX export response should report a project-root-relative path.")
