...
"$PB_COMPILER" "$mcp_check_server_src" --console --thread --output "$mcp_check_server_out"
printf 'Built MCP purebasic/check server: %s\n' "$mcp_check_server_out"
