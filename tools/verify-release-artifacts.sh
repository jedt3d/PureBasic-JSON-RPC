...
require_manifest_entry "MCP/mcp-purebasic-toolkit/README.md"
require_manifest_entry "MCP/mcp-purebasic-toolkit/purebasic_toolkit.pbp"
require_manifest_entry "MCP/mcp-purebasic-toolkit/purebasic_toolkit_server.pb"
require_manifest_entry "MCP/mcp-purebasic-toolkit/purebasic_toolkit_tools.pbi"
require_manifest_entry "MCP/mcp-purebasic-toolkit/docs/milestones.md"
require_manifest_entry "MCP/mcp-purebasic-toolkit/skills/purebasic-pair-development/SKILL.md"
...
require_tar_entry "$package_name/MCP/mcp-purebasic-toolkit/README.md"
require_tar_entry "$package_name/MCP/mcp-purebasic-toolkit/purebasic_toolkit.pbp"
require_tar_entry "$package_name/MCP/mcp-purebasic-toolkit/docs/milestones.md"
require_tar_entry "$package_name/MCP/mcp-purebasic-toolkit/skills/purebasic-pair-development/SKILL.md"
