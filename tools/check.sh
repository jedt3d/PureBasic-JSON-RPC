...
"$ROOT/.build/examples/022-write-queue-close-semantics/write_queue_probe"
"$ROOT/.build/examples/023-trace-logger-hooks/trace_probe"
...
"$ROOT/.build/examples/027-release-quality-gates/release_quality_probe"
